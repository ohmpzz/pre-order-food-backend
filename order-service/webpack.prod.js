...
let plugins = [
  new webpack.DefinePlugin({
    'process.env': {
      PORT: JSON.stringify(process.env.PORT || '3004'),
      MONGO_URI: JSON.stringify(
        process.env.MONGO_URI || 'mongodb://order-db/admin'
      ),
      ...
      PREORDER_SERVICE_URI: JSON.stringify(
        process.env.PREORDER_SERVICE_URI ||
          'http://product-service:3003/preorders'
      ),
    },
  }),
];
